...
@section('content')
    ...
    <section>
        <div class="">
            ...
            @endif
            <form action="{{ route('admin.products.update', $data->id) }}" enctype="multipart/form-data" method="POST"
                id="save-product">
                @method('PUT')
                @csrf
                <div class="card p-5">
                    ...
                    <div class="col-md-12 mt-4">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select class='form-control disabled form-select mt-4' name='seller_id' id="seller_id">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class='form-control mt-4' disabled name='product_type_menu' id="product_type_menu">
                                    ...
                                    <option value="physical_product" <?= $data->type != 'digital_product' ? 'selected' : '' ?>>
                                        {{ labels('admin_labels.physical_product', 'Physical Product') }}
                                    </option>
                                    <option value="digital_product" <?= $data->type == 'digital_product' ? 'checked' : '' ?>>
                            ...
                            <div class="form-group country_list_div">
                                ...
                                <select class="col-md-12 form-control country_list" id="country_list" name="made_in">
                                    @if (isset($data->made_in) && $data->made_in != '')
                                        <option value="{{ $data->made_in }}" {{ !empty($country) && isset($country[0]->name) && $data->made_in == $country[0]->name ? 'selected' : '' }}>
                                            {{ $data->made_in }}
                                        </option>
                                    @endif
                                </select>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id=""
                                                name="is_prices_inclusive_tax" {{ isset($data->is_prices_inclusive_tax) && $data->is_prices_inclusive_tax == '1' ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select deliverable_type" name="deliverable_type"
                                            ...
                                            <option class="all_deliverable_type" value="1" {{ $data->deliverable_type == '1' ? 'selected' : '' }}>
                                                All
                                            </option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="deliverable_zones[]" class="search_seller_zone form-select w-100"
                                            multiple id="deliverable_zones" {{ isset($data->deliverable_type) && ($data->deliverable_type == 2 || $data->deliverable_type == 3) ? '' : 'disabled' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class='form-control shiprocket_type form-select' name="pickup_location"
                                            ...
                                            @foreach ($shipping_data as $val)
                                                <option value="{{ $val->pickup_location }}" @if ($val->pickup_location == $pickup_location) selected @endif>
                                                    {{ $val->pickup_location }}
                                                </option>
                                            @endforeach
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id=""
                                                        name="is_returnable" {{ isset($data->is_returnable) && $data->is_returnable == '1' ? 'checked' : '' }}>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="is_cancelable_checkbox" name="is_cancelable" {{ isset($data->is_cancelable) && $data->is_cancelable == '1' ? 'checked' : '' }}>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 mt-7 {{ isset($data->is_cancelable) && $data->is_cancelable == '1' ? '' : 'collapse' }} "
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class='form-select' name="cancelable_till">
                                            <option value='received' {{ isset($data->cancelable_till) && $data->cancelable_till == 'received' ? 'selected' : '' }}>
                                                Received</option>
                                            <option value='processed' {{ isset($data->cancelable_till) && $data->cancelable_till == 'processed' ? 'selected' : '' }}>
                                                Processed</option>
                                            <option value='shipped' {{ isset($data->cancelable_till) && $data->cancelable_till == 'shipped' ? 'selected' : '' }}>
                                                Shipped</option>
                                        </select>
                                    </div>
                                </div>
                                            ...
                                            <div class="align-items-center d-flex form-group justify-content-end">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="type" id="product-type" class="form-control form-select"
                                                        ...
                                                        <option value="simple_product" {{ isset($data->type) && $data->type == 'simple_product' ? 'selected' : '' }}>
                                                            Simple Product
                                                        </option>
                                                        <option value="variable_product" {{ isset($data->type) && $data->type == 'variable_product' ? 'selected' : '' }}>
                                                            Variable Product
                                                        </option>
                                                        <option value="digital_product" {{ isset($data->type) && $data->type == 'digital_product' ? 'selected' : '' }}>
                                                            Digital Product
                                                        </option>
                                                            ...
                                                            <div class="col col-xs-4 col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select type="text"
                                                                        ...
                                                                        <option value="1" {{ isset($data->stock_type) && $data->stock_type != null && $data->availability == '1' ? 'selected' : '' }}>
                                                                            In Stock</option>
                                                                        <option value="0" {{ isset($data->stock_type) && $data->stock_type != null && $data->availability == '0' ? 'selected' : '' }}>
                                                                            Out Of Stock</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group <?= intval($data->stock_type) > 0 ? '' : 'collapse' ?>"
                                                            ...
                                                            <div class="col-md-12">
                                                                <select id="stock_level_type"
                                                                    ...
                                                                    <option value="product_level" {{ isset($data->id) && $data->stock_type == '1' ? 'Selected' : '' }}>
                                                                        Product Level (
                                                                        Stock
                                                                        Will Be Managed Generally )</option>
                                                                    <option value="variable_level" {{ isset($data->id) && $data->stock_type == '2' ? 'Selected' : '' }}>
                                                                        Variable Level (
                                            ...
                                            <div id="digital_product_setting"
                                                ...
                                                <div class="row form-group">
                                                    <div class="col-md-6 d-flex">
                                                        ...
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="download_allowed" id="download_allowed" {{ $data->download_allowed != 'null' && $data->download_allowed == 1 ? 'checked' : '' }}>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row mt-3 image-upload-section">
                                                <div class="bg-white grow image rounded shadow text-center m-2">
                                                    <div class="image-upload-div">
                                                        <img class="img-fluid" src="{{ route('admin.dynamic_image', [
        'url' => app(MediaService::class)->getMediaImageUrl($data->image),
        'width' => 150,
        'quality' => 90,
    ]) }}" alt="Not Found" />
                                                    </div>
                                                    <input type="hidden" name="pro_input_image" value="{{ $data->image }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                @if (!empty($other_images))
                                                    @foreach ($other_images as $row)
                                                                                            <div class="col-6">
                                                                                                <div class="bg-white grow image rounded shadow text-center m-2">
                                                                                                    <div class="image-upload-div">
                                                                                                        <img class="img-fluid mb-2" src="{{ route('admin.dynamic_image', [
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-select" name="video_type" id="video_type">
                                            <option value="" {{ isset($data->video_type) && ($data->video_type == '' || $data->video_type == null) ? 'selected' : '' }}>
                                                None</option>
                                            <option value="self_hosted" {{ isset($data->video_type) && $data->video_type == 'self_hosted' ? 'selected' : '' }}>
                                                Self Hosted</option>
                                            <option value="youtube" {{ isset($data->video_type) && $data->video_type == 'youtube' ? 'selected' : '' }}>
                                                Youtube</option>
                                            <option value="vimeo" {{ isset($data->video_type) && $data->video_type == 'vimeo' ? 'selected' : '' }}>
                                                Vimeo</option>
                                        </select>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row mt-3 image-upload-section">
                                                <div
                                                    ...
                                                    <input type="hidden" name="pro_input_video" value="{{ $data->video }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control mt-2 d-none mb-2 custom_description_prompt"
                                    ...
                                    placeholder="Enter your own AI prompt (optional)..."></textarea>
                                <textarea name="pro_input_description" id="pro_input_description"
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control mt-2 d-none mb-2 custom_extra_description_prompt"
                                    name="custom_extra_description_prompt"
                                    placeholder="Enter your own AI prompt (optional)..."></textarea>
                                <textarea id="extra_input_description" name="extra_input_description"
                                    class="form-control addr_editor extra_input_description"
                                    placeholder="Place some text here">{{ isset($data->extra_description) ? $data->extra_description : '' }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
