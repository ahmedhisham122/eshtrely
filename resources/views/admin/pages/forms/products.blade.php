                    ...
                    <div class="tab-pane fade show active" id="content-en" role="tabpanel" aria-labelledby="tab-en">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control mt-2" id="short_description"
                                ...
                                <div class="row">
                                    <div class="col-md-6 position-relative">
                                        ...
                                        <div class="position-relative">
                                            <input type="text" class="form-control translated-name-input"
                                                ...
                                                name="translated_product_name[{{ $lang->code }}]" data-lang="{{ $lang->code }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input custom_translated_prompt_toggle" type="checkbox"
                                                        data-lang="{{ $lang->code }}"
                                        ...
                                        <textarea id="language_custom_prompt_{{ $lang->code }}"
                                            ...
                                            placeholder="Enter your own AI prompt (optional)..."></textarea>
                                        <div class="position-relative w-100">
                                            <div class="language_prompt_suggestions list-group position-absolute w-100 z-3 d-none">
                                            </div>
                                        </div>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                        <div class="form-group country_list_div">
                            <label for="made_in" class="form-label">{{ labels('admin_labels.made_in', 'Made IN') }}</label>
                    ...
                    <div class="col-md-6 hsn_code d-none">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tags" placeholder="dress,milk,almond" name="tags">
                            </div>
                        </div>
                </div>
                {{-- custom fields  --}}
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6 total_allowed_quantity">
                                <div class="form-group">
                                    ...
                                    <input type="number" min=0 class="col-md-12 form-control" name="total_allowed_quantity"
                                        value="" placeholder="Total Allowed Quantity">
                                </div>
                            </div>
                            <div class="col-md-6 minimum_order_quantity">
                                <div class="form-group">
                                    ...
                                    <input type="number" min=1 class="col-md-12 form-control" name="minimum_order_quantity"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 warranty_period d-none">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="col-md-12 form-control" name="warranty_period" value=""
                        ...
                        <div class="row d-none">
                            <div class="col-md-6 guarantee_period">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="col-md-12 form-control" name="guarantee_period" value=""
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="deliverable_zones[]" class="search_seller_zone form-select w-100" multiple
                                        {{-- class="search_zone form-select w-100" multiple --}} id="deliverable_zones"
                                        disabled>
                                        <option value="">
                                    </select>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" min=1 class="form-control" value="" name="delivery_charges">
                                </div>
                            </div>
                            <div class="col-md-6 mt-7">
                                <div class="form-group">
                                                                ...
                                                                <div class="col-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" class="form-control"
                                                                            ...
                                                                            id="breadth" min=0 value="0" step="0.01">
                                                                    </div>
                                                                </div>
                                                                <div class="col-6">
                                                                    <div class="form-group">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            ...
                            <textarea id="pro_input_description" name="pro_input_description"
                                class="form-control addr_editor pro_input_description"
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea id="extra_input_description" name="extra_input_description"
                                class="form-control addr_editor extra_input_description" placeholder="Place some text here"></textarea>
                        </div>
                    </div>
                </div>
            </div>
