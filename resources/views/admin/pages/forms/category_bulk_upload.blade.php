...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-lg-6">
            <div class="card">
                <form class="form-horizontal" action="{{ route('categories.bulk_upload') }}" method="POST"
                    id="bulk_upload_form">
                    @csrf
                    <div class="card-body">
                        <h5 class="mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mt-2">
                                        <a href="{{ asset('storage/category-bulk-upload.zip') }}"
                                            class="btn btn-primary btn-sm instructions_files"
                                            download="category-bulk-upload.zip">{{ labels('admin_labels.download', 'Download') }}
        ...
        <div class="col-md-12 col-lg-6 mt-md-2 mt-lg-0">
            <div class="bulk_upload_instruction_card">
                <ul>
                    ...
                    <li>For adding bulk categories, the file should be in .csv format</li>
