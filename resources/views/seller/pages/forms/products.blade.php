...
@endsection
@section('content')
    <x-seller.breadcrumb :title="labels('admin_labels.add_product', 'Add Product')" :subtitle="labels('admin_labels.add_products_with_power_and_simplicity', 'Add products with power and simplicity')" :breadcrumbs="[
    ...
    <div class="">
        <form class="" action="{{ route('seller_products.store') }}" enctype="multipart/form-data" method="POST"
            id="save-product">
            @php
            ...
            <div class="card p-5 mt-4">
                    ...
                    <div class="tab-pane fade show active" id="content-en" role="tabpanel" aria-labelledby="tab-en">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control mt-2" id="short_description" placeholder="Product Short Description"
                ...
                <div class="row">
                    <div class="col-md-6 indicator d-none">
                        <label for="indicator"
