...
@section('content')
    ...
    @endphp
    <x-seller.breadcrumb :title="labels('admin_labels.update_product', 'Update Product')" :subtitle="labels('admin_labels.add_products_with_power_and_simplicity', 'Add products with power and simplicity')" :breadcrumbs="[
    ...
    <section class="overview-statistic">
        <div>
            <form action="{{ route('seller.combo_products.update', $data->id) }} }}" class="submit_form"
                ...
                @endif
                <div class="card p-5">
                    <h6>{{ labels('admin_labels.choose_seller', 'Select Product') }}</h6>
                    <!-- Product Type Select -->
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="product_type_in_combo" id="product_type" disabled>
                                <option value="physical_product"
                                    {{ $data->product_type == 'physical_product' ? 'selected' : '' }}>
                                    {{ labels('admin_labels.physical_product', 'Physical Product') }}
                                </option>
                                <option value="digital_product"
                                    {{ $data->product_type == 'digital_product' ? 'selected' : '' }}>
        ...
        <div class="card p-5 mt-4">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control" id="pro_input_text" placeholder="Gucci"
                                    name="title" value="{{ isset($data->title) ? json_decode($data->title)->en : '' }}">
            ...
            <div class="row">
                ...
                {{-- @dd(app(TranslationService::class)->getDynamicTranslation(Product::class, 'name', $product_details[0]['product_id'], $language_code)); --}}
                <div class="col-md-6 physical_product_in_combo">
                    <div
                        ...
                        <div class="mb-3">
                            ...
                            <select name="physical_product_variant_id[]" class="search_admin_product_for_combo w-100"
                                multiple data-placeholder="Type to search and select products" onload="multiselect()">
                                @isset($data->id)
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-xs-12 {{ $data->has_similar_product == '1' ? '' : 'd-none' }}"
                    ...
                    <select id="" name="similar_product_id[]" value="" data-update=1
                        data-product_id={{ $data->id }} class="select2 form-select search_seller_combo_product  w-100"
                        multiple>
                        @if (isset($data->id))
                    ...
                    <div class="form-group">
                        ...
                        <select name="pro_input_tax[]" class="tax_list form-select w-100" multiple>
                            ...
                            @foreach ($tax_name as $row)
                                <option value="{{ $row->id }}" {{ in_array($row->id, $taxes) ? 'selected' : '' }}>
                                    {{ app(TranslationService::class)->getDynamicTranslation(Tax::class, 'title', $row->id, $language_code) }}({{ $row->percentage }}%)
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control form-select" name="deliverable_type" id="deliverable_type">
                            ...
                            @if ($deliverable_type->deliverable_type == '2' || $deliverable_type->deliverable_type == '3')
                                <option value="1" class="combo_all_deliverable_type d-none"
                                    {{ $data->deliverable_type == '1' ? 'selected' : '' }}>
                                    All
                                </option>
                            @else
                                <option value="1" class="combo_all_deliverable_type"
                                    {{ $data->deliverable_type == '1' ? 'selected' : '' }}>
                                    All
                                </option>
                            @endif
                    ...
                    <div class="form-group">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="d-flex">
                                <label for="" class="me-6 text-muted form-label">[Enable/Disable]</label>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="is_attachment_required_checkbox"
                        ...
                        <div class="col-md-6">
                            <nav class="w-100">
                                <div class="nav nav-tabs" id="product-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="tab-for-general-price" data-bs-toggle="tab"
                                        href="#general-settings" role="tab" aria-controls="general-price"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="simple_special_price"
                                                        ...
                                                        step="0.01" value="{{ $data->special_price }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col col-xs-4 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select type="text"
                                                    ...
                                                    name="simple_product_stock_status" id="simple_product_stock_status">
                                                    <option value="1"
                            ...
                            @if (!empty($other_images))
                                @foreach ($other_images as $row)
                                    <div class="col-md-6 col-sm-12 shadow p-3 mb-3 bg-white rounded text-center image">
                                        ...
                                        <a href="javascript:void(0)" class="delete-img m-2"
                                            data-id="{{ $data->id }}" data-field="other_images"
                                            data-img="{{ $row }}" data-table="combo_products"
