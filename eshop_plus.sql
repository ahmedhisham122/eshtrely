...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 21, 2025 at 06:15 AM
...
--
-- Table structure for table `combo_product_attributes`
--
...
--
-- Table structure for table `combo_product_attribute_values`
--
...
--
-- Table structure for table `combo_product_custom_field_values`
--
...
--
-- Table structure for table `combo_product_faqs`
--
...
--
-- Table structure for table `combo_product_ratings`
--
...
INSERT INTO `languages` (`id`, `language`, `code`, `is_rtl`, `native_language`, `created_at`, `updated_at`) VALUES
(1, 'English', 'en', 0, NULL, '2025-02-12 05:15:34', '2025-02-12 05:15:34');
...
(5, '2023_12_12_999999_add_active_status_to_users', 1),
(6, '2023_12_12_999999_add_avatar_to_users', 1),
(7, '2023_12_12_999999_add_dark_mode_to_users', 1),
(8, '2023_12_12_999999_add_messenger_color_to_users', 1);
...
(36, '1.0.6', '2024-06-06 06:38:08', '2024-06-06 06:38:08');
...
INSERT INTO `users` (`id`, `role_id`, `ip_address`, `username`, `password`, `email`, `mobile`, `image`, `disk`, `balance`, `activation_selector`, `activation_code`, `forgotten_password_selector`, `forgotten_password_code`, `forgotten_password_time`, `remember_selector`, `remember_token`, `created_on`, `last_login`, `active`, `company`, `address`, `bonus_type`, `bonus`, `cash_received`, `dob`, `country_code`, `city`, `area`, `street`, `pincode`, `serviceable_zipcodes`, `serviceable_cities`, `serviceable_zones`, `apikey`, `referral_code`, `friends_code`, `fcm_id`, `latitude`, `longitude`, `type`, `front_licence_image`, `back_licence_image`, `status`, `is_notification_on`, `created_at`, `updated_at`, `active_status`, `avatar`, `dark_mode`, `messenger_color`) VALUES
(1, 1, NULL, 'admin', '$2y$12$OyVep4C3a3xfjC/5365CO.SDyJlMYTSBlnk3VgXeAGP0dqgaUEs7m', 'admin@gmail.com', '9876543210', NULL, '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 'percentage_per_order_item', NULL, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phone', NULL, NULL, 0, 1, '2025-01-10 04:06:55', '2025-01-10 10:28:59', 0, 'avatar.png', 0, NULL);
...
--
-- Indexes for table `combo_product_attributes`
--
ALTER TABLE `combo_product_attributes`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `combo_product_attribute_values`
--
ALTER TABLE `combo_product_attribute_values`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `combo_product_custom_field_values`
--
ALTER TABLE `combo_product_custom_field_values`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `combo_product_faqs`
--
ALTER TABLE `combo_product_faqs`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `combo_product_ratings`
--
...
--
-- AUTO_INCREMENT for table `combo_product_attributes`
--
ALTER TABLE `combo_product_attributes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `combo_product_attribute_values`
--
ALTER TABLE `combo_product_attribute_values`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `combo_product_custom_field_values`
--
ALTER TABLE `combo_product_custom_field_values`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `combo_product_faqs`
--
ALTER TABLE `combo_product_faqs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `combo_product_ratings`
--
ALTER TABLE `combo_product_ratings`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `seller_store`
--
ALTER TABLE `seller_store`
...
--
-- Constraints for table `seller_store`
--
ALTER TABLE `seller_store`
